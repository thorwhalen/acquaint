...
functions ([`acquaint.lookup.find_entity()`](acquaint.lookup.md#acquaint.lookup.find_entity), `acquaint.brief.compose_brief()`, …)
with a [`Store`](acquaint.store.md#acquaint.store.Store).
